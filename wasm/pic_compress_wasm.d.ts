...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_131: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1136: (a: number, b: number, c: number, d: number) => void;
